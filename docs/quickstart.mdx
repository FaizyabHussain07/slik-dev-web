---
title: "Quickstart: Generate SaaS with npx create-slik"
description: "Launch your full-stack app in 60 seconds. Learn how to use the Slik CLI to scaffold Next.js, React, and HTML projects with zero configuration."
---
