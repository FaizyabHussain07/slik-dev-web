---
title: "Slik UI Themes: Bento, Frost, and Mono Explained"
description: "Slik Engine ships three UI themes: Bento, Frost, and Mono. Learn each theme's aesthetic, what screens are generated, and how to pick one during scaffolding."
---
...
<Note>
  **Bento + Next.js is the only available combination today.** Frost and Mono are under active development. The full availability matrix is visible in the [Stack Matrix](/configuration/stacks) section of the docs.
</Note>
